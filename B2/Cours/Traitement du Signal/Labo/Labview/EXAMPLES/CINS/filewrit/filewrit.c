...
/* PERMISSIONS sets the permissions for the created file.  Consult the Code Interface
	Reference Manual for explanation */
int32 PERMISSIONS = 0x1A4;	 /* binary 110100100 */
